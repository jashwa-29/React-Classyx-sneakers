...
const Hero = () => {
  return (
    <section>   
    <div className="bg-main-color w-full lg:h-auto h-auto flex lg:pt-[66px] pt-[40px] lg:pb-[105px] pb-[40px] font-poppins ">
      ...
      data-aos-delay="1000" >
                    <h1 className="lg:text-[59px] md:text-[70px] text-[35px] font-bold">Elevate your style <br/>
