    ...
    <div className="bg-main-color w-full lg:h-auto h-auto flex lg:pt-[66px] pt-[40px] lg:pb-[105px] pb-[40px] ">
        <div className="w-[93%] ml-auto mr-auto">
            <div className="main-hero flex lg:flex-row flex-col-reverse items-center justify-evenly lg:gap-0 gap-[25px]">
                <div className="hero-content flex flex-col items-start gap-[20px]" data-aos="fade-left"  data-aos-duration="1400"
      data-aos-delay="1000" >
                    <h1 className="lg:text-[59px] md:text-[70px] text-[40px] font-bold">Elevate your style <br/>
                ...
                <div className="hero-img" data-aos="fade-left"  data-aos-easing="ease-out-cubic" data-aos-duration="1400"
      data-aos-delay="200" >
