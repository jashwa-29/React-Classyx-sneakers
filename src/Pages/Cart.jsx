...
const Cart = ({cart , setCart}) => {
  ...
  return (
    <>
    <Subhead pname='Cart'/>
    {cart.length === 0 ? (<div className=' font-poppins w-[400px] h-[300px]  flex items-center justify-center rounded-[8px] font-bold text-[26px] mx-auto my-7'><h1> Your Cart is Empty</h1></div>):(    <section className="my-[70px]">
